...
function cloneTask(id, task_type) {
    ...
    clone_div.find('#assigned_state').attr({id: "assigned_state_" + id, class: "states-validate" + id});
    clone_div.find('#accepted_state').attr({id: "accepted_state_" + id, class: "states-validate" + id});
    clone_div.find('#rejected_state').attr({id: "rejected_state_" + id, class: "states-validate" + id});
    clone_div.find('#inprogress_state').attr({id: "inprogress_state_" + id, class: "states-validate" + id});
    clone_div.find('#onhold_state').attr({id: "onhold_state_" + id, class: "states-validate" + id});
    clone_div.find('#resolved_state').attr({id: "resolved_state_" + id, class: "states-validate" + id});
