...
//    function SubmitForm()
//    {
//        console.log($('[name="fse_type_id"]').val());
//        
...
<div class="x_panel"  style="height:900px;">
    <div class="x_title">
        <h2>Add Service Enginner<small></small></h2>

        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <br />
        <form  id="Add_ServiceEnginner" name="Add_ServiceEnginner" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url() ?>addserviceEngineer" method="POST">
            ...
            <div class="form-group">
                <label for="fse_type_id" class="control-label col-md-3 col-sm-3 col-xs-12">FSE Type<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12" autocomplete="on">
                        <input value="<?php echo @$post['fse_type_id'] ?>" required id="fse_type_id" style="width:500px;" type="text" class="form-control" name="fse_type_id"/>
                         
                        <div style="display:none" id="fse_type_error" generated="true" class="error">Please Add Valid FSE Email</div>
...
<script>
                        ...
                        $(document).ready(function () {
////                            var data4 = [];
////                            //data4 = $('#fse_type_id').trigger('selectionchange', [this, this.getSelectedItems()]);
////// $('#fse_type_id').trigger('selectionchange', [this, this.getSelectedItems()]);
////
////                            $(".fse_type_id").trigger("selectionchange").change(function () {
////                                console.log("88Handler for .change() called.");
////                            });
////
//                            $('#tag-input-0').change(function () {
//                                console.log("Handler for .change() called.");
//                            });
////
////                            $('#fse_type_id').tagSuggest({
////                                value
////                            })
//$("#tag-input-0").click(function(){
//    console.log('ddddd');
//});
//
//                            $('[name="fse_type_id"]').bind("change", function () {
...
//                            $('[name="fse_type_id"]').tagSuggest(function(element, options){
//                                console.log("uu"+element);
//                            });
                            console.log('ddddd');
                            $('[name="fse_type_id"]').on('select', function () {
                                console.log("File is changed.");
                            });
                            console.log($('[name="fse_type_id"]').val());
...
$(document).ready(function () {
    $('#Add_ServiceEnginner')
        .find('[name="fse_type_id"]')
            // Revalidate the countries field when it is changed
            .change(function (e) {
                $('#Add_ServiceEnginner').formValidation('revalidateField', 'fse_type_id');
            })
            .end()
        .formValidation({
            framework: 'bootstrap',
            ...
            fields: {
                fse_type_id: {
                    validators: {
                        notEmpty: {
                            message: 'Please enter at least one fse type '
                        }
                    }
                },
                fse_type_id: {
                    validators: {
                        callback: {
                            message: 'Please enter 2-4 fse_type_id ',
                            callback: function (value, validator, $field) {
                                // Get the entered elements
                                var options = validator.getFieldElements('fse_type_id');
