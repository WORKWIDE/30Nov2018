<div class="x_panel" style="min-height:600px; height: auto;">
    <div class="x_title">
        ...
        <a href="<?php echo base_url() ?>addCustomer" id="send"  class="btn btn-success" style="float:right;">Add Customer</a>
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ...
                    <tr>
                        ...
                        <td><form action="<?php echo base_url(); ?>updateCustomer" method="post">
