<div class="x_panel" style="min-height:600px; height: auto;">
    <div class="x_title">
        <h2>SLA <small></small></h2>
        <a href="<?php echo base_url() ?>addSLA" id="send"  class="btn btn-success" style="float:right;">Add SLA</a>
        ...
        <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ...
                    <tr>
                        <td><?php echo $i++ ?></td>
                        <td><?php echo $r['sla_name']; ?></td>
                        <td><?php echo $r['sla_details']; ?></td>
                        <td><form action="<?php echo base_url(); ?>updateSLA" method="post">
