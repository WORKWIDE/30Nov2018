...
<div class="x_panel"  style="height:600px;">
    ...
    <div class="x_content">
        <br />
        <form id="Add_Branch" name="Add_Branch" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url() ?>addBranch" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    echo form_dropdown('ent_id', $ent_type, set_value('ent_id'), $attributes);
                    ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="branch_name" name="branch_name" value="<?php echo @$post['branch_name'] ?>" class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control col-md-7 col-xs-12" name="branch_location" id="branch_location"><?php echo @$post['branch_location'] ?></textarea>
                    <span class="text-danger"><?php echo form_error('branch_location'); ?></span>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a href="<?php echo base_url() ?>addBranch" class="btn btn-primary">Cancel</a>  
