<style type="text/css">
    #Edit_Priority_Type label.error {
        color: #FB3A3A;
        ...
        $(D).ready(function ($) {
            JQUERY4U.UTIL.setupFormValidation();
              ...
              <div class="x_panel"  style="height:600px;">
                <div class="x_title">
                  <h2>Edit Priority Type<small></small></h2>
                  
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <br />
                  <form id="Edit_Priority_Type" name="Edit_Priority_Type" data-parsley-validate class="form-horizontal form-label-left" action="" method="POST">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="priority_type" name="priority_type" value="<?php echo $result[0]['priority_type']; ?>" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control col-md-7 col-xs-12" name="priority_description" id="priority_description"><?php echo $result[0]['priority_description']; ?></textarea>
