...
<div class="x_panel"  style="height:900px;">
    ...
    <div class="x_content">
        <br />
        <form id="Add_Project" name="Add_Project" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url() ?>addProject" method="POST">
...
<!--            <div class="form-group">
            ...
            <input type="hidden" name="proj_created_date"  value="<?php echo date("Y/m/d H:i"); ?>" />
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Project Name<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="proj_name" name="proj_name" value="<?php echo @$post['proj_name'] ?>" class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control col-md-7 col-xs-12" name="proj_company_address" id="proj_company_address"><?php echo @$post['proj_company_address'] ?></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control col-md-7 col-xs-12" name="proj_details" id="proj_details"><?php echo @$post['proj_details'] ?></textarea>
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a href="<?php echo base_url() ?>addProject" class="btn btn-primary">Cancel</a>  
