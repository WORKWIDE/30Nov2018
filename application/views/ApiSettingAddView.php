...
<div class="x_panel"  style="min-height:600px;">
    <div class="x_title">
        <h2>Add API<small></small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <br />
        <form id="Add_API" name="Add_API" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url() ?>apiSetting_add" method="POST">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a href="<?php echo base_url() ?>apiSetting_add" class="btn btn-primary">Cancel</a>  
