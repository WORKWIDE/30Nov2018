        ...
        <table id="datatable" class="table table-striped table-bordered tasklists ">
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ...
                    <tr class="row_show_<?php echo $k ?>"   onclick="taskdetail(this,'row_show_<?php echo $k ?>','<?php echo $r['id']; ?>','<?php echo $i; ?>')">
                        <td><?php echo $i++ ?></td>
...
<script>
     ...
     function taskdetail(f,container,id,rnum) {
    ...
    alert(container);
      ...
      success: function (resp) {   
       ...
       // $("#datatable tbody ."+container+"").append(resp);
      // $('#datatable > tbody > tr').eq(rnum-1).html("");
       // $('#datatable > tbody > tr').eq(rnum-1).insertAfter(resp);
       //delete(resp); 
       
       $(f).closest('tr').after(resp);
