<div class="x_panel" style="min-height:600px; height: auto;">
    <div class="x_title">
        ...
        <a href="<?php echo base_url() ?>addProject" id="send"  class="btn btn-success" style="float:right;">Add Project</a>
        ...
        <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <tbody>	
                ...
                foreach ($result AS $r) {
                    ...
                    <tr>
                        <td><?php echo $i++ ?></td>
                        <td><?php echo $r['proj_created_date']; ?></td>
                        <td><?php echo $r['proj_name']; ?></td>
                        <td><?php echo $r['status_type']; ?></td>
                <form action="<?php echo base_url(); ?>updateProject" method="post">
                    <td>
                        ...
                        <button class="fa fa-times" name="close" value="close" title="COMPLETE" onclick="return confirm('Are you sure you want to close this project?');"></button>
