        ...
        ?> 
                    ...
                    <h2>Task Attachments :</h2>
                                ...
                                if ($attachmentdata != NULL) {
                                    foreach ($attachmentdata as $v) {
                                        ...
                                        <?php if ($i == 1) { ?>   
                                    <?php } ?> 
                                    <div style = "vertical-align:top; padding:15px; background-color:#e6e6e6; float:left; width:94%; text-align:left; margin-bottom: 10px;margin-bottom: 15px;box-shadow: 0px 3px 8px #ccc;">
                                        <div style="width:20%; float:left; ">
                                        <img src = "data:image/jpeg;base64, <?php echo $v['customer_document'] ?>" style ="width: 100%; border: 5px solid #fff; float:left;">
                                        </div>
                                        <div style="width:62%; float:left">
                                            
                                            <div style="width:40%; float:left;margin-left:10%;">
                                <?php if ($v['created_date']) { ?>
                                            <h3 style="text-align:left; margin-top:0px;margin-bottom: 0; "><b> Upload Date: </b></h3>
            ...
            <?php } ?>
                        ...
                        <?php if ($v['attachment_value']) {
                            $showlable = 0; ?>
                                            <h3 style="text-align:left; margin-bottom: 0; margin-top: 0;"><b> Metadata :</b> </h3>
