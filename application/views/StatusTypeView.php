...
<!--    <div class="x_title">
        <h2>Status Type <small></small></h2>
        <a href="<?php echo base_url() ?>addStatusType" id="send"  class="btn btn-success" style="float:right;">Add Status Type</a>
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ...
                    <tr>
                        ...
                        <?php if ($this->session->userdata('session_data')->is_admin == 1) { ?>
                        <td><form action="<?php echo base_url(); ?>updateStatusType" method="post">
