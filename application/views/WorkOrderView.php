<div class="x_panel" style="min-height:600px; height: auto;">
    <div class="x_title">
        <h2>Work Order <small></small></h2>
        <a href="<?php echo base_url() ?>addWorkOrder" id="send"  class="btn btn-success" style="float:right;">Add Work Order</a>
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $r['work_order_description']; ?></td>
                        <td><form action="<?php echo base_url(); ?>updateWorkOrder" method="post">
                                <input type="hidden" value="<?php echo $r['id']; ?>" name="edit_id"  />
                                <input type="hidden" value="<?php echo $r['task_id']; ?>" name="task_id"  />
