<div class="x_panel" style="min-height:600px; height: auto;">
    <div class="x_title">
        ...
        <a href="<?php echo base_url() ?>addBranch" id="send"  class="btn btn-success" style="float:right;">Add Branch</a>
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $r['branch_location']; ?></td>
                        <td><form action="<?php echo base_url(); ?>updateBranch" method="post">
