...
<div class="x_panel"  style="height:900px;">
    <div class="x_title">
        <h2>Edit Incident<small></small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <br />
        <form id="Edit_Incident" name="Edit_Incident" data-parsley-validate class="form-horizontal form-label-left" action="" method="POST">
...
<!--            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="incident_name" name="incident_name" value="<?php echo $result[0]['incident_name']; ?>" class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control col-md-7 col-xs-12" name="incident_company_address" id="incident_company_address"><?php echo $result[0]['incident_company_address']; ?></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control col-md-7 col-xs-12" name="incident_details" id="incident_details"><?php echo $result[0]['incident_details']; ?></textarea>
            ...
            <!--<div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    //echo form_dropdown('sla_id', $sla_name, set_value('sla_id', $result[0]['sla_id']), $attributes);
                    ?>
			...
			<div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 controls input-append date form_datetime"  data-date-format="dd MM yyyy" data-link-field="dtp_input1">
                    <input size="16" readonly type="text" value="<?php echo $result[0]['start_date']; ?>" name="start_date" id="datetimepicker_start"   class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <a href="<?php echo base_url() ?>incident" class="btn btn-primary">Cancel</a>  
...
//                    $("#datetimepicker_end").datepicker("option", "minDate", dt);
//                }
//    });
//    $('#datetimepicker_end').datetimepicker({
//       
...
//                    var dt = new Date(selected);
//                    dt.setDate(dt.getDate() - 1);
//                    $("#datetimepicker_start").datepicker("option", "maxDate", dt);
//                }
//    });
</script>
